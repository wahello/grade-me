...
export interface IInstructorDialogProps {
    open: boolean;
    text?: string;
    name: string;
    login: string;
...
export interface IInstructorDialogState {
}

@observer
export class InstructorDialog extends React.Component<IInstructorDialogProps, IInstructorDialogState> {
    constructor(props: IInstructorDialogProps) {
        super(props);
    }
    ...
    public render() {
        ...
        return (
            ...
            >
                <DialogTitle id='instructor-dialog-title'>Instructor</DialogTitle>
                <DialogContent>
